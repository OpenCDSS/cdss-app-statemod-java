...
#
# git-clone-all-sm - clone all StateMod Java repositories for new development environment setup
...
# StateMod Java GitHub repo URL root
githubRootUrl="https://github.com/OpenCDSS"

# Main StateMod Java repository
mainRepo="cdss-app-statemod-java"
